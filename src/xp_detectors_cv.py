...
if __name__ == '__main__':
    ...
    detector_configs = pandas.read_pickle(results_path/'tuning_results/best_configs.pk') 
    ...
    results_df.to_pickle((Path('/srv/newpenny/XAI/generated_data/attacks_ijcnn/results_detectors.pk')).as_posix())