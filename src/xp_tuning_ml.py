...
def detector_wrap(config, **kwargs):
    ...
    if checkpoint != None:
        with checkpoint.as_directory() as checkpoint_dir:
            data_path = tune_path/"checkpoint.pk"
...
if __name__ == '__main__':
    ...
    target_layers = ['features.28', 'features.14', 'classifier.0', 'classifier.3']
    ...
    pickle.dump(save_configs, open(results_path/'best_configs.pk', 'wb'))
